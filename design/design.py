...
class Ui_Weights(object):
    def setupUi(self, Weights):
        ...
        self.textShow = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.textShow.setWhatsThis("")
        self.textShow.setText("")
        self.textShow.setTextFormat(QtCore.Qt.AutoText)
        self.textShow.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        self.textShow.setWordWrap(False)
        self.textShow.setOpenExternalLinks(False)
        self.textShow.setObjectName("textShow")
        self.horizontalLayout_2.addWidget(self.textShow)
